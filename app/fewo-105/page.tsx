...
export const metadata: Metadata = {
  ...
  description:
    "50 qm Ferienwohnung 105 mit überdachtem Balkon, direkt am Zwischenahner Meer. Nichtraucher, allergikerfreundlich.",
};

const rooms = [
  { href: "/fewo-105", label: "Übersicht" },
...
export default function Fewo105Page() {
  return (
    <ApartmentPageClient
      apartment={105}
      title="Wohnung 105"
      subtitle="Nichtraucher · Allergikerfreundlich · 50 qm · 4. Etage mit Fahrstuhl"
